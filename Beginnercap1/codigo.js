...
const definirCompra = (n) => {
    let din = Number(prompt(`Dinero de ${n}`));

    if (din >= 0.6 && din < 1) {
        alert(`Tu vuelto es ${(din - 0.6).toFixed(2)}`);
        return alert(`${n}: helado de agua`);
    }

    if (din >= 1 && din < 1.6) {
        alert(`Tu vuelto es ${(din - 1).toFixed(2)}`);
        return alert(`${n}: helado de crema`);
    }

    if (din >= 1.6 && din < 1.7) {
        alert(`Tu vuelto es ${(din - 1.6).toFixed(2)}`);
        return alert(`${n}: helado de heladix`);
    }

    if (din >= 1.7 && din < 1.8) {
        alert(`Tu vuelto es ${(din - 1.7).toFixed(2)}`);
        return alert(`${n}: helado de heladovich`);
    }

    if (din >= 1.8 && din < 2.9) {
        alert(`Tu vuelto es ${(din - 1.8).toFixed(2)}`);
        return alert(`${n}: helado de helardo`);
    }

    if (din >= 2.9) {
        alert(`Tu vuelto es ${(din - 2.9).toFixed(2)}`);
        return alert(`${n}: helado de confetis`);
    }

    return alert(`${n}: no te alcanza para nada`);
};
